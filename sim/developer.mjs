...
async function ask(prompt,shots=[]){
  ...
  const res=await fetch('https://generativelanguage.googleapis.com/v1beta/openai/chat/completions',{
    ...
    signal:AbortSignal.timeout(120000),body:JSON.stringify({model:'gemini-3.6-flash',temperature:.35,max_tokens:12000,response_format:{type:'json_object'},messages:[{role:'user',content}]})});
